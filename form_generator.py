...
def buat_formulir_otomatis(data, petugas):
    ...
    # --- PENGATURAN KOP FORMULIR (Sisi Kiri) ---
    pdf.set_line_width(0.3)
    margin_x = 10
    kop_y = 10
    lebar_kop_kiri = 90
    tinggi_kop = 32 # Tinggi area kop agar logo tidak menumpuk
    ...
    # PERBAIKAN LOGO: Ukuran logo diperkecil dan posisi X/Y dijaga agar tidak menutupi teks kop
    ...
    headers = [["Dok", "HJF-FR-OHS-113"], ["Tgl Terbit", "12-10-2023"], ["No. Rev", "03"], ["Hal", "3"]]
    pdf.set_font("helvetica", "", 8)
    for h in headers:
        pdf.set_x(100)
        pdf.cell(25, 8, h[0], border=1) # Kolom Label (Dok, Tgl, dll)
        pdf.cell(75, 8, h[1], border=1, ln=True, align="C") # Kolom Isi (HJF-..., 12-10-..., dll)
    ...
    # Jarak baris 7.5mm agar muat 14 kolom dalam satu halaman A4
    ...
    # --- TAMBAHAN: BAGIAN BAWAH DENGAN BINGKAI KOTAK ---
    pdf.ln(5)
    y_pernyataan_box = pdf.get_y()
    
    # Kotak pembungkus untuk area Surat Pernyataan dan Tanda Tangan
    ...
    # Area Tanda Tangan (di pojok kanan kotak)
    pdf.ln(5)
